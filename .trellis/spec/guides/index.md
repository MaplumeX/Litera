...
- [ ] You want to persist a new user preference next to theme — `preferences.json` uses `deny_unknown_fields`; a new key resets old builds (UI locale, default reader/Agent mode, and chrome font/size use `localStorage`, see frontend `i18n.md`)
