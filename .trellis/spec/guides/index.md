...
- [ ] You want to persist a new user preference next to theme — `preferences.json` uses `deny_unknown_fields`; a new key resets old builds (UI locale, default reader/Agent mode, chrome font/size, and TTS rate/voice use `localStorage`, see frontend `i18n.md`)
